...
- [X]  Explain benefit(s) using `client-side routing`?
 ...
 Client Side routing offers control over your site URL & content without necessarily having to wait for a server to respond with content. It is designed to mimic the appearance of traditional multi page websites.
